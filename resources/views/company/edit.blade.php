            ...
            <form id="form" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="country" name="country">
                            ...
                            @foreach ($countries as $id => $name)
                                <option value="{{ $id }}" @if ($company->country == $id) selected @endif>
                                    {{ $name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="state" name="state">
                            ...
                            @foreach ($states as $stateId => $stateName)
                                <option value="{{ $stateId }}" @if ($company->state == $stateId) selected @endif>
                                    {{ $stateName }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control" id="city" name="city">
                            ...
                            @foreach ($cities as $cityId => $cityName)
                                <option value="{{ $cityName }}" @if ($company->city == $cityId) selected @endif>
                                    {{ $cityName }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group" id="logo_upload">
                        ...
                        @if ($company->logo)
                            <a href="{{ asset('uploads/company/' . $company->logo) }}" alt="Logo" class="btn btn-primary mt-2">View</a>
